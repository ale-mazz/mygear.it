...
$qry = mysqli_query($conn, "SELECT Codice_prodotto, Nome, Descrizione, Prezzo, Img, Disponibilita, Alt FROM raffreddamento ORDER BY Prezzo ASC");
...
foreach ($products as $product){
    ...
    $get_product=str_replace('$img$',"../../images/categorie/raffreddamento/".$product["Img"], $get_product);
...
$page = str_replace('$hvraf$', 'notClickable', $page);
