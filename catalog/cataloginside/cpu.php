...
$qry = mysqli_query($conn, "SELECT Codice_prodotto, Nome, Descrizione, Prezzo, Img, Disponibilita, Alt FROM cpu ORDER BY Prezzo ASC");
...
foreach ($products as $product){
    ...
    $get_product=str_replace('$img$',"../../images/categorie/cpu/".$product["Img"], $get_product);
...
$page=str_replace('$titlecat$','CPU' ,$page);
...
$page = str_replace('$hvcpu$', 'notClickable', $page);
