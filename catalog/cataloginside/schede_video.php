...
$qry = mysqli_query($conn, 'SELECT Codice_prodotto, Nome, Descrizione, Prezzo, Img, Disponibilita, Alt FROM schede_video ORDER BY Prezzo ASC');
...
foreach ($products as $product){
    ...
    $get_product=str_replace('$img$',"../../images/categorie/schede_video/".$product["Img"], $get_product);
...
$page=str_replace('$titlecat$','SCHEDE VIDEO' ,$page);
...
$page = str_replace('$hvsv$', 'notClickable', $page);
