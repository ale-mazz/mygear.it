...
$qry = mysqli_query($conn, "SELECT Codice_prodotto, Nome, Descrizione, Prezzo, Img, Disponibilita, Alt FROM mouse_tastiere ORDER BY Prezzo ASC");
...
foreach ($products as $product){
    ...
    $get_product=str_replace('$img$',"../../images/categorie/mouse_tastiere/".$product["Img"], $get_product);
...
$page=str_replace('$titlecat$','MOUSE & TASTIERE' ,$page);
...
$page = str_replace('$hvmt$', 'notClickable', $page);
