...
$qry = mysqli_query($conn,"SELECT Codice_prodotto, Nome, Descrizione,Prezzo,Img,Disponibilita FROM monitor ORDER BY Codice_prodotto");
...
$page=str_replace('$titlecat$','MONITORS' ,$page);
