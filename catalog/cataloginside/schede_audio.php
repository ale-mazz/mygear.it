...
$qry = mysqli_query($conn, "SELECT Codice_prodotto, Nome, Descrizione, Prezzo, Img, Disponibilita, Alt FROM schede_audio ORDER BY Prezzo ASC");
...
foreach ($products as $product){
    ...
    $get_product=str_replace('$img$',"../../images/categorie/schede_audio/".$product["Img"], $get_product);
...
$page=str_replace('$titlecat$','SCHEDE AUDIO' ,$page);
...
$page = str_replace('$hvsa$', 'notClickable', $page);
