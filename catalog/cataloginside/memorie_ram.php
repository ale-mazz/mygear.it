...
$qry = mysqli_query($conn, "SELECT Codice_prodotto, Nome, Descrizione, Prezzo, Img, Disponibilita, Alt FROM memorie_ram ORDER BY Prezzo ASC");
...
$page = str_replace('$hvmr$', 'notClickable', $page);
