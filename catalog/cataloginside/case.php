...
$qry = mysqli_query($conn, "SELECT Codice_prodotto, Nome, Descrizione, Prezzo, Img, Disponibilita, Alt FROM case_pc ORDER BY Prezzo ASC");
...
foreach ($products as $product){
    ...
    $get_product=str_replace('$img$',"../../images/categorie/case/".$product["Img"], $get_product);
...
$page=str_replace('$titlecat$','CASE' ,$page);
...
$page = str_replace('$hvcase$', 'notClickable', $page);
