...
$qry = mysqli_query($conn, "SELECT Codice_prodotto, Nome, Descrizione, Prezzo, Img, Disponibilita, Alt FROM memorie_interne ORDER BY Prezzo ASC");
...
foreach ($products as $product){
    ...
    $get_product=str_replace('$img$',"../../images/categorie/memorie_interne/".$product["Img"], $get_product);
...
$page=str_replace('$titlecat$','MEMORIE INTERNE' ,$page);
...
$page = str_replace('$hvmi$', 'notClickable', $page);
