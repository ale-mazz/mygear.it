...
$qry = mysqli_query($conn,"SELECT Codice_prodotto, Nome, Descrizione,Prezzo,Img,Disponibilita FROM schede_madri ORDER BY Codice_prodotto");
...
foreach ($products as $product){
    ...
    $get_product=str_replace('$img$',"../../images/categorie/schede_madri".$product["Img"], $get_product);
...
$page=str_replace('$titlecat$','SCHEDE MADRI' ,$page);
